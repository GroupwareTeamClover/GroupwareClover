...
//             return ResponseEntity.status(HttpStatus.UNAUTHORIZED).build();
//         }
//         chatService.leaveChat(roomSeq, empSeq);
...
//             return ResponseEntity.status(HttpStatus.UNAUTHORIZED).build();
//         }
//         chatService.clearChatHistory(roomSeq, empSeq);
//         return ResponseEntity.ok().build();
//     }

//     @PostMapping("/notifications/{roomSeq}")
//     public ResponseEntity<?> toggleNotifications(@PathVariable int roomSeq, @RequestBody boolean enabled, HttpSession session) {
//         Integer empSeq = (Integer) session.getAttribute("cloverSeq");
//         if (empSeq == null) {
//             return ResponseEntity.status(HttpStatus.UNAUTHORIZED).build();
//         }
//         chatService.toggleNotifications(roomSeq, empSeq, enabled);
//         return ResponseEntity.ok().build();
//     }
