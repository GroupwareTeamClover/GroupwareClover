...
//         params.put("roomSeq", roomSeq);
//         params.put("empSeq", empSeq);
//         mybatis.delete("Chat.removeUserFromRoom", params);
//     }
...
//         return mybatis.selectOne("Chat.getRoomParticipantCount", roomSeq);
//     }
...
//         mybatis.delete("Chat.deleteRoom", roomSeq);
//     }
...
//         params.put("roomSeq", roomSeq);
//         params.put("empSeq", empSeq);
//         mybatis.delete("Chat.deleteChatHistory", params);
//     }
...
//         params.put("roomSeq", roomSeq);
//         params.put("empSeq", empSeq);
//         params.put("enabled", enabled); // 'Y' 또는 'N'
//         mybatis.update("Chat.updateNotificationSettings", params);
//     }
// }