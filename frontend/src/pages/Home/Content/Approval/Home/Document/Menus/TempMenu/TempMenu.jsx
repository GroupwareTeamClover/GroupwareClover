...
export const TempMenu=({setIsTempInsert, setIsTempEmergency, setIsTempTemp})=>{
    ...
    return(
        <div className={styles.container}>
            ...
            <span className={styles.menuspancenter} onClick={handleTempTemp}><BsDownload size={19} className={styles.menuright}/>임시저장</span>
