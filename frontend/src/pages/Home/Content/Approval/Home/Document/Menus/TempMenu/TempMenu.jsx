...
export const TempMenu=({isTempEmergency, setIsTempInsert, setIsTempEmergency, setIsTempTemp, setIsTempCancle})=>{
    ...
    return(
        <div className={styles.container}>
            ...
            <span className={styles.menuspancenter}><MdEmergency className={styles.menuright}/>긴급여부<input type="checkbox" className={styles.inputcheck} 
            onChange={handleTempEmergencyChange} defaultChecked={isTempEmergency === 'y'}></input></span>
        </div>
    )
}